---
description: "Quick reference for docs/solutions/ frontmatter fields, enum values, category mapping, and YAML safety rules"
---
...
fields like `description:` have their own quoting rules.
