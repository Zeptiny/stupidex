...
description: 'Format-rendering reference for markdown artifacts — principles for rendering any artifact in markdown.'
---
...
It is paired with a section contract (`ideation-sections.md`,
etc.) that describes *what* the artifact contains.
