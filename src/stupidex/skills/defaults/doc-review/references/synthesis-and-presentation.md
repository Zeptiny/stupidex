---
name: synthesis-and-presentation
description: 'Synthesis pipeline, presentation layer, and next-action logic for document review.'
---
...
- Do not modify caller skills (brainstorm, plan, or external plugin skills that invoke doc-review)
