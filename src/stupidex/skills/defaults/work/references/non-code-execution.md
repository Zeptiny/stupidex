---
name: non-code-execution
description: 'Carve-out for knowledge-work plans (execution: knowledge-work). Covers non-code deliverables like synthesized documents, study artifacts, and research write-ups.'
---

# Non-Code Execution (Knowledge-Work Carve-Out)

Loaded from Phase 0 Input Triage when the plan carries `execution: knowledge-work`. The plan is a **production plan** for a non-code deliverable (a synthesized document, a study artifact, a research write-up) — typically produced by `plan`'s approach-altitude flow. Execute it to produce the deliverable. This is a minority-case branch; the normal code lifecycle does not apply and is not invoked here.
