---
description: Markdown rendering principles for brainstorm artifacts -- format invariants, ID prefix format, content shape rules, section anatomy, diagram rendering.
---
...
When a bullet has substructure that benefits from named fields, use bold
leader labels at the start of nested bullets -- not deeper heading levels.
...
Markdown renders diagrams as fenced mermaid blocks:
